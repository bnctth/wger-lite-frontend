...
const Modal = ({
  ...
  return (
    <>
      {enabled &&
        createPortal(
          <div className="fixed top-0 w-dvw h-dvh  z-10 flex justify-center items-center">
            <div className="bg-white border shadow p-10 rounded">
              ...
              <div className="flex flex-col items-stretch">
                <IconButton
                  ...
                  extraCss="before:fixed before:top-0 before:left-0 before:w-dvw before:h-dvh before:bg-opacity-80 before:bg-gray-200 before:-z-50"
                >
                  Cancel
                </IconButton>
              </div>
